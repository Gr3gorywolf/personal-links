  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Gregory's Links! Explore my collection of links and discover my various online profiles."
        />
        <meta
          name="keywords"
          content="Gregory's Links, Links, Profile, Social Media"
        />
